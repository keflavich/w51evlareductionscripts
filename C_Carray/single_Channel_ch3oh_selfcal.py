...
if ii > 1:
    ...
    clean(vis=vis, spw='0', imagename='ch3oh_256_chan632_selfcal{0:02d}'.format(ii),
          ...
          multiscale=multiscale,
          selectdata=True)
    exportfits('ch3oh_256_chan632_selfcal{0:02d}.image'.format(ii),'ch3oh_256_chan632_selfcal{0:02d}.image.fits'.format(ii))
    exportfits('ch3oh_256_chan632_selfcal{0:02d}.model'.format(ii),'ch3oh_256_chan632_selfcal{0:02d}.model.fits'.format(ii))
    exportfits('ch3oh_256_chan632_selfcal{0:02d}.residual'.format(ii),'ch3oh_256_chan632_selfcal{0:02d}.residual.fits'.format(ii))
    ...
    os.system('rm -rf ch3oh_256_chan632_selfcal_blcal{0:02d}.*'.format(ii))
    clean(vis=vis, spw='0', imagename='ch3oh_256_chan632_selfcal_blcal{0:02d}'.format(ii),
          field='W51 Ku',
          weighting='uniform', imsize=[256,256], cell=['1.0 arcsec'],
          mode='mfs', threshold=threshold, niter=100,
          multiscale=multiscale,
          selectdata=True)
    exportfits('ch3oh_256_chan632_selfcal_blcal{0:02d}.image'.format(ii),'ch3oh_256_chan632_selfcal_blcal{0:02d}.image.fits'.format(ii))
    exportfits('ch3oh_256_chan632_selfcal_blcal{0:02d}.model'.format(ii),'ch3oh_256_chan632_selfcal_blcal{0:02d}.model.fits'.format(ii))
    exportfits('ch3oh_256_chan632_selfcal_blcal{0:02d}.residual'.format(ii),'ch3oh_256_chan632_selfcal_blcal{0:02d}.residual.fits'.format(ii))
...
if os.path.exists('../13A-064.sb28612538.eb29114303.56766.55576449074.ms'):
