...
f[0].data = integ1
f[0].writeto(dpath('H2CO_11_C_C_tausummed_68to71.fits'))

integ2 = tau[18:42,:,:].sum(axis=0)
f[0].data = integ2
f[0].writeto(dpath('H2CO_11_C_C_tausummed_42to61.fits'))

integ3 = tau[48:56,:,:].sum(axis=0)
f[0].data = integ3
f[0].writeto(dpath('H2CO_11_C_C_tausummed_63to67.fits'))
...
f[0].data = integ1
f[0].writeto(dpath('H2CO_11_C_C_absorbsummed_68to71.fits'))

integ2 = cspec[18:42,:,:].sum(axis=0)
f[0].data = integ2
f[0].writeto(dpath('H2CO_11_C_C_absorbsummed_42to61.fits'))

integ3 = cspec[48:56,:,:].sum(axis=0)
f[0].data = integ3
f[0].writeto(dpath('H2CO_11_C_C_absorbsummed_63to67.fits'))



integ3 = tau[18:62,:,:].sum(axis=0)
f[0].data = integ3
f[0].writeto(dpath('H2CO_11_C_C_tausummed_42to67.fits'))

integ3 = cspec[18:62,:,:].sum(axis=0)
f[0].data = integ3
f[0].writeto(dpath('H2CO_11_C_C_absorbsummed_42to67.fits'))
